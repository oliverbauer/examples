...
public class MeshUtil {
	...
	public MeshUtil(float x, float y, float z, float width, float height, float depth) {
		// manual of the last
	...
	public MeshUtil alignLeftSideWithRightSideOf(MeshUtil prev) {
	...
	public MeshUtil modify(MOD mod) {
		if (mod == MOD.ONE) {
	...
	public MeshUtil finialize(MeshPartBuilder mpb) {
